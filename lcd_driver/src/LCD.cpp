...
//
// This base class is a pure abstract class and needs to be extended. As
// reference, it has been extended to drive 4 and 8 bit mode control, LCDs and
// I2C extension backpacks such as the I2CLCDextraIO using the PCF8574* I2C IO
// Expander ASIC.
//
//
// @version API 1.1.0
...
void LCD::backlight(void) { setBacklight(255); }

//
// Switch off the backlight
void LCD::noBacklight(void) { setBacklight(0); }
...
// ---------------------------------------------------------------------------
void LCD::command(uint8_t value) { send(value, COMMAND); }
